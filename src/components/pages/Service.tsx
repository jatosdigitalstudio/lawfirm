...
export default function Service() {
    return (
        <section className="relative flex flex-col justify-center h-[50rem] items-center px-6 mb-20 bg-[url(https://images.unsplash.com/photo-1505663912202-ac22d4cb3707?q=80&w=2070&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D)] bg-cover bg-no-repeat">
            <div className="absolute inset-0 bg-maroon/80 z-10" />
            <div className="container mx-auto w-[85%] z-30" id="practice">
                <div className="flex flex-col bg-[#F4F5EF] rounded-xl py-20 px-28 mt-[-20rem] mb-12">
                    <div className="w-[40%] text-black flex flex-col max-w-4xl mb-16">
                    ...
                    <div className="grid grid-cols-3 gap-8">
                        {
                            SERVICES.map((item) =>(
                                <div 
                                    key={item.id}
                                    className="flex flex-col justify-center space-y-2 bg-white py-16 px-12 rounded-xl w-full">
